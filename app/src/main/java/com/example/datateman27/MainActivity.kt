...
import com.example.datateman27.databinding.ActivityMainBinding
        ...
        when (p0?.getId()) {
            R.id.save -> {
                ...
                if (isEmpty(getNama) || isEmpty(getAlamat) || isEmpty(getNoHP)) {
                    ...
                    getReference.child("Admin").child(getUserID).child("DataTeman27").push()
                        .setValue(data_teman27(getNama, getAlamat, getNoHP))
